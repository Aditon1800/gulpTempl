...
$.fn.flipster = function(options) {
    ...
    return this.each(function() {
        ...
        function buildButtonContent(dir) {
            ...
            return '<svg viewBox="0 0 30 30" xmlns="' + svgNS + '" aria-labelledby="title"><title>'+text+'</title><path d="M 15,0 L 1,15 L 15,30 M 30,15 L 1,15"' + (dir === 'next' ? ' transform="rotate(180 15,15)"' : '' ) + '/></svg>';
        }
